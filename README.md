...
This is a sample template for aws-lambda-test - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name aws-lambda-test --query 'Stacks[].Outputs'
```
